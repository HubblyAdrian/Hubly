# Hubly Architecture Documentation & Developer Experience

**Version:** 1.0.0  
**Milestone:** 1 · Section 17  
**Owner:** Hubly Brain / Platform Engineering

This is the **single source of truth** for how Hubly thinks, how modules connect, and how future engineers extend the platform safely — without reverse-engineering the codebase or relying on tribal knowledge.
...
4. [Architecture Decision Records](../adr/README.md) — *why* we designed it this way  
...
| AI Lifecycle | [`AI_LIFECYCLE.md`](./AI_LIFECYCLE.md) |
| Builder Engine Spec (Milestone 1.5 prep) | [`BUILDER_ENGINE_SPEC.md`](./BUILDER_ENGINE_SPEC.md) |
| Memory | [`MEMORY_GUIDE.md`](./MEMORY_GUIDE.md) |
| Expert Development | [`EXPERT_DEVELOPMENT.md`](./EXPERT_DEVELOPMENT.md) |
| Business DNA | [`BUSINESS_DNA_GUIDE.md`](./BUSINESS_DNA_GUIDE.md) |
