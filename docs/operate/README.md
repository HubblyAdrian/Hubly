...
| Settings | [SETTINGS_CHECKLIST.md](./SETTINGS_CHECKLIST.md) · [SETTINGS_ARCHITECTURE.md](./SETTINGS_ARCHITECTURE.md) · [SETTINGS_PLAN.md](./SETTINGS_PLAN.md) · [SETTINGS_MAT.md](./SETTINGS_MAT.md) | ✅ | ⏸ | ✅ | 🔒 OS |
