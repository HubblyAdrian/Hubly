...
check(
  ...
  /Version|Rollback|Business Builder|Booking Intelligence|Workspace Intelligence|Automation Intelligence|Epic [5-9]/i.test(`${snap.builderActions?.epic || ""} ${snap.builderActions?.note || ""}`),
);
