...
check(
  ...
  /Preview|Collaboration|Version|Rollback|Business Builder|Booking Intelligence|Workspace Intelligence|Epic [3-8]/i.test(`${snap.builderActions?.epic || ""} ${snap.builderActions?.note || ""}`),
);
