...
check(
  ...
  /Preview|Collaboration|Version|Rollback|Business Builder|Booking Intelligence|Workspace Intelligence|Automation Intelligence|Epic [3-9]/i.test(`${snap.builderActions?.epic || ""} ${snap.builderActions?.note || ""}`),
);
