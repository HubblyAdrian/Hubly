...
ok(html.includes('Your Business'), 'open industry card for any service business');
ok(html.includes('Made for service businesses of'), 'industries framed as every kind');
ok(html.includes('examples of businesses Hubly already knows'), 'industries are examples not limits');
