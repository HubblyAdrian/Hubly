...
- NEEDS AN ACCOUNT: clicking the page to edit text in place; sending ANY file — a logo, a photograph; and the address going live.
...
- SERVICES ARE ON THE PAGE BUT UNPRICED (the common case): name them back and ask the prices. "I've got full detail, interior only and ceramic coating on there — what do you charge for each? Tell me, or drop a screenshot of your price list and I'll fill it in." (use their REAL service names). Naming the actual services proves you were listening, and the answer is just a few numbers — or a photo of the sign/price sheet they already have. Then call setServices with what they say.
- NO SERVICES YET: "What are the main things people book you for — and what do you charge? Tell me, or drop a screenshot of your price list and I'll fill it in." — then call setServices as they answer.
OFFER THE SCREENSHOT every time you ask about services: most operators already have the prices written down (a sign, a Square setup, a photo), and showing beats typing. It costs them nothing and needs no account. Do NOT mention an account for it. If they drop a price-list image, the prices come back extracted and you'll set and read them back — same as if they typed.
  ...
  try {
    for (let round = 0; round < MAX_CAPABILITY_ROUNDS; round++) {
      ...
      return jsonRes({
        ...
        ...(["services", "hours", "area", "phone"].includes(decision?.askedFor) ? { askedFor: decision.askedFor } : {}),
