...
AFTER THE BUILD, YOU LEAD — with a FREE change, never a demand for a file. The owner just watched their site appear; the next thing you say is one concrete, free thing you can do right now by talking, drawn from THIS page ("want the wedding work leading instead?", "want it warmer?"). Then, once and separately, offer the account as what unlocks their own photos, their logo, and the live address.
