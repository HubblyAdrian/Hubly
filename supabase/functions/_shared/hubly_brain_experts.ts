...
export function ensureExpertsRegistered(): void {
  ...
  registerExpert({
    ...
    responsibilities: [
      "Review every customer-facing response",
      "Veto unnecessary complexity",
      "Enforce one Hubly personality",
    ],
    capability: {
  ...
  registerExpert({
    ...
    responsibilities: ["Industry research", "Customer psychology", "Seasonality & objections"],
    capability: {
  ...
  registerExpert({
    ...
    responsibilities: ["Positioning", "Offer hierarchy", "Homepage priorities"],
    capability: {
  ...
  registerExpert({
    ...
    responsibilities: ["Creative direction", "Explainable design choices", "First-screen trust"],
    capability: {
  ...
  registerExpert({
    ...
    responsibilities: ["Coherence review", "Confidence check", "Request clarify when thin"],
    capability: {
      can: ["critic", "review", "qa", "build", "website", "research"],
      tools: [],
      reads: ["business_memory"],
      actions: ["block", "request_clarify"],
    },
    allowedTools: [],
    allowedActions: ["block", "request_clarify"],
    inputs: ["priorOutputs"],
