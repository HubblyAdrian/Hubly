 ...
 *
 * Phase 7.4 marks Memory-safe skills executable:true.
 * Website Builder / destructive platform skills stay false until migrated.
 * The AI never manipulates the database directly — Executors write Memory/SSOT.
 */
...
export type HublySkill = {
  ...
  /** Phase 7.4 — true only when an executor exists and is safe */
  executable: boolean;
};
