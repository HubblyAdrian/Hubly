  ...
  function renderJobsPage(root) {
    ...
    if (mainView === 'calendar') {
      mainBody =
        ...
        '<div><h2 class="jos-jobs-cal-title">Calendar</h2><p class="jos-muted">Drag on empty time to create · name it as a job or block · drag the bottom edge to resize.</p></div>' +
