    ...
    S.customers = [
      {
        ...
        vehicles: [{ label: 'Tesla Model Y · Pearl White · CAL-4821', type: 'SUV' }, { label: 'Model 3 · Midnight Silver', type: 'Sedan' }],
        property: '',
        preferredService: 'Ceramic Coating',
        customerType: 'recurring',
        membership: 'Monthly Interior',
        recurringAmount: 120,
        statusOverride: 'vip',
        status: 'active',
        favorite: true,
        tags: ['VIP', 'Member', 'Ceramic', 'Referral'],
        ...
        notesList: ['Prefers Saturday mornings', 'Referred two customers', 'Asked about yearly maintenance'],
        documents: [{ name: 'Ceramic warranty.pdf', kind: 'warranty' }, { name: 'Membership agreement.pdf', kind: 'membership' }],
        photos: [{ label: 'Before · exterior', at: '2024-05-04' }, { label: 'After · ceramic', at: '2024-05-04' }],
        payments: [{ id: 'pay_sj1', amount: 720, status: 'paid', at: todayOffset(-36), method: 'Card' }, { id: 'pay_sj2', amount: 220, status: 'paid', at: todayOffset(-72), method: 'Card' }, { id: 'pay_sj3', amount: 120, status: 'paid', at: todayOffset(-14), method: 'Membership' }],
      ...
      },
      {
        ...
        vehicles: [{ label: 'BMW X5 · Black', type: 'SUV' }],
        preferredService: 'Interior Detail',
        customerType: 'one_off',
        membership: '',
        status: 'active',
        favorite: false,
        tags: ['Interior', 'Upsell'],
        assignedTo: 'Luis Ortega',
        aiScore: 72,
        unread: 0,
        notes: 'Responds best to text. Interested in membership after 2 more visits.',
        notesList: ['Responds best to text', 'Membership after 2 more visits'],
        documents: [{ name: 'Receipt · Interior Detail.pdf', kind: 'receipt' }],
        photos: [{ label: 'Cabin before', at: todayOffset(-20) }],
        payments: [{ id: 'pay_mb1', amount: 220, status: 'paid', at: todayOffset(-20), method: 'Card' }],
      ...
      },
      {
        ...
        city: 'San Diego',
        vehicle: 'Audi Q5',
        vehicles: [{ label: 'Audi Q5', type: 'SUV' }],
        preferredService: 'Full Detail',
        customerType: 'one_off',
        membership: '',
        status: 'active',
        favorite: true,
        tags: ['Reviewer', 'Full Detail'],
        assignedTo: 'Maya Chen',
        aiScore: 81,
        unread: 0,
        notes: 'Left a 5-star review. Good testimonial candidate.',
        notesList: ['5-star review on file', 'Testimonial candidate'],
        documents: [],
        photos: [{ label: 'Full detail after', at: todayOffset(-10) }],
        payments: [{ id: 'pay_es1', amount: 320, status: 'paid', at: todayOffset(-10), method: 'Card' }],
      ...
      },
      {
        ...
        address: '5500 Grossmont Center Dr, La Mesa, CA',
        city: 'La Mesa',
        vehicle: 'F-150 · White',
        vehicles: [{ label: 'F-150 · White', type: 'Truck' }],
        preferredService: 'Exterior Detail',
        customerType: 'one_off',
        membership: '',
        status: 'active',
        favorite: false,
        tags: ['At Risk', 'Abandoned'],
        assignedTo: 'Luis Ortega',
        aiScore: 38,
        unread: 2,
        notes: 'Abandoned booking at vehicle size step.',
        notesList: ['Abandoned at vehicle size', 'Needs follow-up'],
        documents: [],
        photos: [],
        payments: [],
      ...
      },
      {
        ...
        address: '2910 Mission Blvd, San Diego, CA',
        city: 'San Diego',
        vehicle: 'Porsche Macan · Gray',
        vehicles: [{ label: 'Porsche Macan · Gray', type: 'SUV' }],
        preferredService: 'Ceramic Coating',
        customerType: 'one_off',
        membership: '',
        status: 'active',
        favorite: false,
        tags: ['New', 'Hot', 'Ceramic'],
        assignedTo: 'Adrian Lopez',
        aiScore: 88,
        unread: 1,
        notes: 'Google lead — hot on ceramic coating package.',
        notesList: ['Google lead', 'Hot on ceramic package'],
        documents: [],
        photos: [],
        payments: [],
      ...
      },
      {
        ...
        city: 'San Diego',
        vehicle: 'F-150 · Blue',
        vehicles: [{ label: 'F-150 · Blue', type: 'Truck' }],
        property: 'Office park · Mission Valley',
        preferredService: 'Paint Correction',
        customerType: 'one_off',
        membership: '',
        status: 'inactive',
        favorite: false,
        ...
        aiScore: 55,
        unread: 0,
        notes: 'Seasonal fleet work — usually books spring/fall.',
        notesList: ['Seasonal fleet', 'Spring/fall bookings'],
        documents: [{ name: 'Fleet estimate.pdf', kind: 'estimate' }],
        photos: [],
        payments: [],
